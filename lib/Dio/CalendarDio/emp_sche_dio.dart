...
class EmpScheDio {
  ...
  Future<JsonParser> readEmpSche(int empNo, int empSchNo) async {
    Response res = await DioInterceptor.dio
        .get("http://172.20.10.2:8080/empSchedule/read/$empNo/$empSchNo");
    print(res.data); //맞음
  ...
  Future<List<JsonParser>> readEmpTodo(int empNo, DateTime selectDate) async {
    ...
    print(formated);
    Response res = await DioInterceptor.dio
        .get("http://172.20.10.2:8080/empTodo/read/$empNo/$formated");
    print(res.data);
    print('$empNo');
  ...
  Future<dynamic> modEmpSchedule(DateTime startDate, DateTime endDate,
    ...
    print("empMod dio");
    var uri =
        Uri.parse("http://172.20.10.2:8080/empSchedule/mod/$empNo/$empSchNo");
    print(uri);
  ...
  Future<dynamic> delEmpSch(int empNo, int empSchNo) async {
    print("empMod dio");
    var uri = Uri.parse("http://172.20.10.2:8080/empSchedule/$empNo/$empSchNo");
    print(uri);
