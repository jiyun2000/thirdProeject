...
class CalendarDio {
  ...
  Future<Map<String, dynamic>> findByMap(int empNo, int deptNo) async {
    Response res = await DioInterceptor.dio.get(
        "http://192.168.0.14:8080/empDeptSchedule/readSche/$deptNo/$empNo");
    print(res.data);
    print('empNO => $empNo');
    print('deptNo => $deptNo');
    print("dio = > ${res.data}");
  ...
  Future<dynamic> addEmpSchedule(DateTime startDate, DateTime endDate,
    ...
    var uri = Uri.parse("http://192.168.0.14:8080/empSchedule/register/$empNo");
    Map data = {
  ...
  Future<dynamic> addDeptSche(DateTime startDate, DateTime endDate,
    ...
    var uri = Uri.parse(
        "http://192.168.0.14:8080/deptSchedule/register/$deptNo/$empNo");
  ...
  Future<empDto> todaySchedule(
    ...
    Response res = await DioInterceptor.dio.get(
        "http://192.168.0.14:8080/empDeptSchedule/list/$deptNo/$empNo/$formated");
    // print(res.data);
